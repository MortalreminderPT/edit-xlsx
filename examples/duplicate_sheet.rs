...
fn main() -> WorkbookResult<()> {
    ...
    let worksheet_name = worksheet.get_name().to_string();

    let worksheet = workbook.duplicate_worksheet_by_name(&worksheet_name)?;
    worksheet.write("B1", 50)?;
    worksheet.write("B2", 1)?;
    worksheet.write("B5", 2)?;
    worksheet.write("B6", 4)?;
    worksheet.write("B7", 6)?;
    worksheet.write("C1", 30)?;
    worksheet.write("C2", 20)?;
    worksheet.write("C5", 123)?;
    worksheet.write("C6", 456)?;
    worksheet.write("C7", 789)?;
    worksheet.activate();
