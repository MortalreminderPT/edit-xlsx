...
fn main() {
    ...
    // let mut worksheet = workbook.get_sheet_by_name_mut("Sheet1").unwrap();
    let mut worksheet = workbook.get_sheet_mut(1).unwrap();
    ...
    let mut worksheet = workbook.get_sheet_mut(2).unwrap();
